...
beforeAll(async () => {
    ...
    category = await Category.create({ name: 'telefonia' })
...
//? GET ALL
test("GET -> 'BASE_URL', should resturn status code 200 and res.body.legnth = 1 and category to definede", async () => {
...
//? GET ONE
test("GET -> 'BASE_URL/:id', should resturn status code 200 and res.body.title === product.title", async () => {
